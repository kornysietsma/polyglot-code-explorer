...
export function numberOfChangersScale(config, metadata, stats) {
...
export function depthScaleBuilder(config, metadata, stats) {
  return d3
...
export function earlyLateScaleBuilder(config, metadata, stats) {
